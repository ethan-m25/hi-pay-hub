#!/usr/bin/env python3
"""
hi-pay-hub/scripts/update-jobs.py
Daily job data updater — Hawaii Pay Hub edition.
"""
...
def main():
    ...
    db["meta"] = {
        ...
        "updated": TIMESTAMP,
        "state": "Hawaii",
        "law": "HRS § 378-2.8 Pay Transparency Act",
        "currency": "USD",
        "region": "HI",
    }
